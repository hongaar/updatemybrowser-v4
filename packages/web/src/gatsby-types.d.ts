...
type SanitySiteSettings = Node & SanityDocument & {
  readonly _createdAt: Maybe<Scalars['Date']>;
  readonly _id: Maybe<Scalars['String']>;
  readonly _key: Maybe<Scalars['String']>;
  readonly _rawAuthor: Maybe<Scalars['JSON']>;
...
type SanitySiteSettingsSortInput = {
  readonly fields: InputMaybe<ReadonlyArray<InputMaybe<SanitySiteSettingsFieldsEnum>>>;
  readonly order: InputMaybe<ReadonlyArray<InputMaybe<SortOrderEnum>>>;
};
...
type ArchivePageQueryQuery = { readonly posts: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly publishedAt: string | null, readonly title: string | null, readonly _rawExcerpt: Record<string, unknown> | null, readonly mainImage: { readonly alt: string | null, readonly crop: { readonly _key: string | null, readonly _type: string | null, readonly top: number | null, readonly bottom: number | null, readonly left: number | null, readonly right: number | null } | null, readonly hotspot: { readonly _key: string | null, readonly _type: string | null, readonly x: number | null, readonly y: number | null, readonly height: number | null, readonly width: number | null } | null, readonly asset: { readonly _id: string | null } | null } | null, readonly slug: { readonly current: string | null } | null } }> } };
...
type BlogPostTemplateQueryQuery = { readonly post: { readonly id: string, readonly publishedAt: string | null, readonly title: string | null, readonly _rawExcerpt: Record<string, unknown> | null, readonly _rawBody: Record<string, unknown> | null, readonly categories: ReadonlyArray<{ readonly _id: string | null, readonly title: string | null } | null> | null, readonly mainImage: { readonly alt: string | null, readonly crop: { readonly _key: string | null, readonly _type: string | null, readonly top: number | null, readonly bottom: number | null, readonly left: number | null, readonly right: number | null } | null, readonly hotspot: { readonly _key: string | null, readonly _type: string | null, readonly x: number | null, readonly y: number | null, readonly height: number | null, readonly width: number | null } | null, readonly asset: { readonly _id: string | null } | null } | null, readonly slug: { readonly current: string | null } | null, readonly authors: ReadonlyArray<{ readonly _key: string | null, readonly author: { readonly name: string | null, readonly image: { readonly crop: { readonly _key: string | null, readonly _type: string | null, readonly top: number | null, readonly bottom: number | null, readonly left: number | null, readonly right: number | null } | null, readonly hotspot: { readonly _key: string | null, readonly _type: string | null, readonly x: number | null, readonly y: number | null, readonly height: number | null, readonly width: number | null } | null, readonly asset: { readonly _id: string | null } | null } | null } | null } | null> | null } | null };

type DefaultSEOQueryQueryVariables = Exact<{ [key: string]: never; }>;


type DefaultSEOQueryQuery = { readonly site: { readonly title: string | null, readonly description: string | null, readonly keywords: ReadonlyArray<string | null> | null, readonly author: { readonly name: string | null } | null } | null };

type IndexPageQueryQueryVariables = Exact<{ [key: string]: never; }>;


type IndexPageQueryQuery = { readonly site: { readonly title: string | null, readonly description: string | null, readonly keywords: ReadonlyArray<string | null> | null } | null, readonly posts: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly publishedAt: string | null, readonly title: string | null, readonly _rawExcerpt: Record<string, unknown> | null, readonly mainImage: { readonly alt: string | null, readonly crop: { readonly _key: string | null, readonly _type: string | null, readonly top: number | null, readonly bottom: number | null, readonly left: number | null, readonly right: number | null } | null, readonly hotspot: { readonly _key: string | null, readonly _type: string | null, readonly x: number | null, readonly y: number | null, readonly height: number | null, readonly width: number | null } | null, readonly asset: { readonly _id: string | null } | null } | null, readonly slug: { readonly current: string | null } | null } }> } };

type SanityImageFragment = { readonly crop: { readonly _key: string | null, readonly _type: string | null, readonly top: number | null, readonly bottom: number | null, readonly left: number | null, readonly right: number | null } | null, readonly hotspot: { readonly _key: string | null, readonly _type: string | null, readonly x: number | null, readonly y: number | null, readonly height: number | null, readonly width: number | null } | null, readonly asset: { readonly _id: string | null } | null };

type SiteTitleQueryQueryVariables = Exact<{ [key: string]: never; }>;


type SiteTitleQueryQuery = { readonly site: { readonly title: string | null } | null };

type Unnamed_1_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_1_Query = { readonly allSanityPost: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly publishedAt: string | null, readonly slug: { readonly current: string | null } | null } }> } };
